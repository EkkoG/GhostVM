...
public final class WindowlessVMSession: NSObject, VZVirtualMachineDelegate {
    ...
    public init(name: String, bundleURL: URL, layout: VMFileLayout, storedConfig: VMStoredConfig, headless: Bool, runtimeSharedFolder: RuntimeSharedFolderOverride?) throws {
